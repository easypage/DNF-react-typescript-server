...
class CharacterSearch{
  ...
  async defaultSearch(serverValue, characterId) { 
    ...
    try {
    const equipment = await axios.get(CHARACTERHTTP + "/equip/equipment" + SearchAPIKey)
    const avatar = await axios.get(CHARACTERHTTP + "/equip/avatar" + SearchAPIKey)
    const creature = await axios.get(CHARACTERHTTP + "/equip/creature" + SearchAPIKey)
    const flag = await axios.get(CHARACTERHTTP + "/equip/flag" + SearchAPIKey)
    const talisman = await axios.get(CHARACTERHTTP + "/equip/talisman" + SearchAPIKey)
